...
function initSingleReviewsSlider(containerSelector, prevBtnSelector, nextBtnSelector, currentIndicatorSelector, externalData = null) {
...
// Экспортируемая функция для инициализации всех слайдеров отзывов
export function initReviewsSlider(externalData = null) {
    // Инициализируем первый слайдер (основной)
    const slider1 = initSingleReviewsSlider(
        '.ms-slide__container',
    ...
    const slider2 = initSingleReviewsSlider(
    ...
    // Инициализируем третий слайдер
    const slider3 = initSingleReviewsSlider(
